...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('follow', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='followuser', to='users.follow')),
        ...
        migrations.AddField(
            model_name='follow',
            name='user_follow',
            field=models.ManyToManyField(related_name='follows', through='users.FollowUser', to=settings.AUTH_USER_MODEL),
        ),
    ]
