# Generated by Django 3.2.16 on 2023-12-11 13:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'Гость'), ('auth_user', 'Авторизованный пользователь'), ('admin', 'Администратор')], default='user', max_length=9, verbose_name='Уровень доступа')),
